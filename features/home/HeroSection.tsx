  ...
  return (
    <header ref={containerRef} className="relative min-h-[160vh] flex flex-col items-center">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <GlowOrb color="bg-blue-600" className="top-[-10%] left-[-10%] opacity-[0.06] blur-[220px]" size="900px" />
        <GlowOrb color="bg-indigo-500" className="bottom-[-10%] right-[-10%] opacity-[0.06] blur-[240px]" size="800px" />
      ...
      <div 
        className="fixed bottom-10 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center pointer-events-none w-full"
        style={{ 
      ...
      >
        ...
        >
          ...
          <div className={`w-[2px] h-14 relative overflow-hidden rounded-full ${isDark ? 'bg-white/10' : 'bg-slate-200'}`}>
